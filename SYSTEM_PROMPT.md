...
-   **To find the right tool**: Read `llms.txt` to get the full list of tool signatures, including required and optional inputs.
...
-   **Key files for context**: The most important files for you to read are:
    -   `llms.txt`: The main discovery entry point.
    -   `knowledge-core/principles.md`: The five core principles.
    -   `skills/<skill-name>/SKILL.md`: The detailed specification for each skill.
