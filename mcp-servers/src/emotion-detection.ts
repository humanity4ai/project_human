 ...
 */
import {
  FEAR_ANXIETY_PATTERNS,
  SADNESS_GRIEF_PATTERNS,
  ANGER_FRUSTRATION_PATTERNS,
  LONELINESS_ISOLATION_PATTERNS,
  SHAME_GUILT_PATTERNS,
  LOVE_CONNECTION_PATTERNS,
} from "./patterns.js";

export interface EmotionDetectionResult {
  category: string;
  confidence: number; // 0-1, proportional to matched patterns
  matched: string[];
}
