 ...
 * Provides locale-aware reply templates for all 10 skills.
 *
...
const supportiveReplies: Record<SupportedLocale, string> = {
...
export function getSupportiveReply(message: string, locale: SupportedLocale): string {
...
const crisisResources: Record<SupportedLocale, { primary: string; secondary: string }> = {
...
export function getLocalizedCrisisResources(locale: SupportedLocale): { primary: string; secondary: string } {
  return crisisResources[locale] || crisisResources.en;
}

// ─── WCAG AA Assessment i18n ──────────────────────────────────────────────────

const wcagCategories: Record<SupportedLocale, Record<string, string>> = {
  en: {
...
export function getLocalizedCategory(category: string, locale: SupportedLocale): string {
