...
export declare const MAX_WORDS_PER_SENTENCE = 20;
/** Maximum content word count before chunking recommendation */
export declare const MAX_CONTENT_WORDS = 150;
/** Minimum word count before numbered-step recommendation triggers */
export declare const MIN_STEPS_SEQUENCE_THRESHOLD = 50;
/** Minimum touch target size in pixels (WCAG 2.5.5) */
export declare const MIN_TOUCH_TARGET_PX = 44;
/** Minimum body font size in pixels for readability */
export declare const MIN_BODY_FONT_PX = 16;
/** Recommended minimum line height factor */
export declare const MIN_LINE_HEIGHT_FACTOR = 1.5;
